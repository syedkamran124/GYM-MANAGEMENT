...
public class DietPlan extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           try
           {
            ...
            out.println("<title>Diet Plan</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<li class='nav-item'>"
                    + "<div class='nav-link active'>Diet Plan</div>"
                    + "</li>"
                    + "<li class='nav-item'>"
            ...
            out.println("<div class='container'>"
                    ...
                    + "<tr class='bg-dark text-white'><th colspan='3' class='text-center'>Diet Plan</th></tr>"
                    + "<tr><th class='text-center'>Time</th><th class='text-center'>Meal</th><th class='text-center'>Food Items</th></tr>"
                    + "<tr><td>8:00-9:00 AM</td><td>Breakfast</td>"
                    + "<td>2 Roti With Sabji & Salad<br> Oats Meal Porridge + Dry Fruits</td></tr>"
                    + "<tr><td>11:00-12:00 PM</td><td>Mid Morning</td>"
                    + "<td>Banana Shake With <br>1 Scoop Peanut Butter</td></tr>"
                     + "<tr><td>2:00-3:00 PM</td><td>Lunch</td>"
                    + "<td>3 Roti + Brown Rise<br>Pulse(Dal)/Chicken/Fish/<br>Seasonal Vegetables +"
                    + "Low Fat Curd</br>Sprouts + Veg Salad</td></tr>"
                     + "<tr><td>5:00-6:00 PM</td><td>Evening Snacks</td>"
                    + "<td>Banana Shake With <br>1 Scoop Peanut Butter</td></tr>"
                     + "<tr><td>8:00-9:00 PM</td><td>Dinner</td>"
                    + "<td>Boiled Brown Rice + Paneer<br>Seasonal Vegetables<br>Sprouts + Veg Salad</td></tr>"
                     + "<tr><td>10:00 PM</td><td>Bed Time</td><td>Toned Milk + 1 Scoop Gainer</td></tr>"
                     + "<tr><td colspan='3' class='text-center'>Before Workout - 2 Banana Or 1 Apple<br>"
                    + "After Workout - 2 Scoop Gainer with Water</td></tr>"
                    + "</table>"
                    + "<button onclick='window.print()' class='btn btn-outline-primary btn-lg'>PRINT"
                    + "</button>"
                    + "</div>"
                    + "</div>"
                    + "</div>");
